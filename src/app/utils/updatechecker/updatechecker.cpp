...
UpdateChecker::UpdateChecker(const QString& checkUrl, QObject *parent)
    : QObject(parent), m_url(checkUrl), m_doingUpdateCheck(false)
{
...
void UpdateChecker::performVersionCheck()
{
    ...
    QNetworkRequest versionCheck(m_url + QApplication::applicationVersion());
