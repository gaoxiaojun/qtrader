...
BarRequest::BarRequest(BarType barType, long barSize, const bool& isBarFactoryRequest)
{
...
void BarRequest::setIsBarFactoryRequest(const bool& isbarfactoryrequest)
{
