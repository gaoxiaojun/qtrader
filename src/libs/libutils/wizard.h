...
class UTILS_EXPORT Wizard : public QWizard
{
    Q_OBJECT
...
class UTILS_EXPORT WizardProgress : public QObject
{
    Q_OBJECT
...
class UTILS_EXPORT WizardProgressItem // managed by WizardProgress
{
