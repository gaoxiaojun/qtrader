...
UTILS_EXPORT Utils::ReloadPromptAnswer Utils::reloadPrompt(const QString &fileName,
                                                                     bool modified,
                                                                     QWidget *parent)
{
...
UTILS_EXPORT Utils::ReloadPromptAnswer Utils::reloadPrompt(const QString &title,
...
UTILS_EXPORT Utils::FileDeletedPromptAnswer
