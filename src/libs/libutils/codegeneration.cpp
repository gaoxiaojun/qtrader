...
UTILS_EXPORT QString fileNameToCppIdentifier(const QString &s)
{
    QString rc;
...
UTILS_EXPORT QString headerGuard(const QString &file)
{
    return headerGuard(file, QStringList());
}

UTILS_EXPORT QString headerGuard(const QString &file, const QStringList &namespaceList)
{
    const QChar underscore = QLatin1Char('_');
    QString rc;
...
UTILS_EXPORT void writeBeginQtVersionCheck(QTextStream &str)
{
