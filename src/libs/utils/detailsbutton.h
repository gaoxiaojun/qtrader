...
namespace Utils {
class UTILS_EXPORT FadingPanel : public QWidget
{
    Q_OBJECT
...
class UTILS_EXPORT FadingWidget : public FadingPanel
{
    Q_OBJECT
public:
...
class UTILS_EXPORT DetailsButton : public QAbstractButton
{
    Q_OBJECT
