...
UTILS_EXPORT QString winErrorMessage(unsigned long error)
{
...
UTILS_EXPORT QString winGetDLLVersion(WinDLLVersionType t,
                                                const QString &name,
...
UTILS_EXPORT bool winIs64BitSystem()
{
...
UTILS_EXPORT bool winIs64BitBinary(const QString &binaryIn)
{
