...
BarRequest BarRequestList::add(BarType barType, long barSize, bool isBarFacroryRequest)
{
...
bool BarRequestList::contains(BarType barType, long barSize, bool isBuiltFromTrades)
{
