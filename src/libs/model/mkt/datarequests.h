...
public:
    ...
    void setHasBarRequests(bool hasbarrequests);

    bool hasDailyRequest() const;
    void setHasDailyRequest(bool hasdailyrequest);

    bool hasMarketDepthRequest() const;
    void setHasMarketDepthRequest(bool hasmarketdepthrequest);

    bool hasQuoteRequest() const;
    void setHasQuoteRequest(bool hasquoterequest);

    bool hasTradeRequest() const;
    void setHasTradeRequest(bool hastraderequest);
