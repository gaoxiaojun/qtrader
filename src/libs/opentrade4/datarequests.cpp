...
BarRequest DataRequests::add(BarType barType, long barSize, bool isBarFacroryRequest)
{
...
void DataRequests::setHasBarRequests(bool hasbarrequests)
{
...
void DataRequests::setHasDailyRequest(bool hasdailyrequest)
{
...
void DataRequests::setHasMarketDepthRequest(bool hasmarketdepthrequest)
{
...
void DataRequests::setHasQuoteRequest(bool hasquoterequest)
{
...
void DataRequests::setHasTradeRequest(bool hastraderequest)
{
