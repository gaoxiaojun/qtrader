...
TwsConsolePane::TwsConsolePane(QObject *parent)
...
TwsConsolePane::~TwsConsolePane()
{
    writeSettings();
    delete m_consoleWidget;
}

QWidget *TwsConsolePane::outputWidget(QWidget *)
{
    return m_consoleWidget;
}

QList<QWidget *> TwsConsolePane::toolBarWidgets() const
{
     return QList<QWidget *>() << m_showDebugButton << m_showWarningButton << m_showErrorButton
                               << m_spacer << m_statusLabel;
}

int TwsConsolePane::priorityInStatusBar() const
{
    return 20;
}

void TwsConsolePane::clearContents()
{
    QmlConsoleModel::qmlConsoleItemModel()->clear();
}

void TwsConsolePane::visibilityChanged(bool /*visible*/)
{
}

bool TwsConsolePane::canFocus() const
{
    return true;
}

bool TwsConsolePane::hasFocus() const
{
    return m_consoleWidget->hasFocus();
}

void TwsConsolePane::setFocus()
{
    m_consoleWidget->setFocus();
}

bool TwsConsolePane::canNext() const
{
    return false;
}

bool TwsConsolePane::canPrevious() const
{
    return false;
}

void TwsConsolePane::goToNext()
{
}

void TwsConsolePane::goToPrev()
{
}

bool TwsConsolePane::canNavigate() const
{
    return false;
}

void TwsConsolePane::readSettings()
{
...
void TwsConsolePane::setContext(const QString &context)
{
    m_statusLabel->setText(context);
}

void TwsConsolePane::writeSettings() const
{
    QSettings *settings = Core::ICore::settings();
