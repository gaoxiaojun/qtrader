...
#ifndef TwsConsolePane_H
#define TwsConsolePane_H
...
class TwsConsolePane : public Core::IOutputPane
{
    Q_OBJECT
public:
    TwsConsolePane(QObject *parent);
    ~TwsConsolePane();

    QWidget *outputWidget(QWidget *);
    QList<QWidget *> toolBarWidgets() const;
    QString displayName() const { return tr("Tws Console"); }
