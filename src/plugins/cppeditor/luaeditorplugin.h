...
class LuaQuickFixAssistProvider;
...
public:
    ...
    LuaQuickFixAssistProvider *quickFixProvider() const;
...
private:
    ...
    LuaQuickFixAssistProvider *m_quickFixProvider;
...
public:
    LuaEditorFactory(LuaEditorPlugin *owner);

    Core::IEditor *createEditor(QWidget *parent);

private:
    LuaEditorPlugin *m_owner;
};
