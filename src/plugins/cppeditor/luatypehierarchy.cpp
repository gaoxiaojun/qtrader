...
QStandardItem *itemForClass(const CppClass &cppClass)
{
    ...
    QVariant link;
    link.setValue(LuaEditorWidget::Link(cppClass.link));
    ...
    m_noTypeHierarchyAvailableLabel(0)
{
    ...
    connect(LuaEditorPlugin::instance(), SIGNAL(typeHierarchyRequested()), SLOT(perform()));
}
...
void CppTypeHierarchyWidget::perform()
{
    ...
    LuaElementEvaluator evaluator(widget);
    ...
    if (evaluator.identifiedCppElement()) {
        ...
        LuaElement *element = cppElement.data();
