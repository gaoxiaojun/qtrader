...
#include "luavirtualfunctionproposalitem.h"
...
public:
    ...
    IAssistProposal *immediateProposal(const TextEditor::IAssistInterface *)
    {
        ...
        BasicProposalItem *hintItem = new VirtualFunctionProposalItem(LuaEditorWidget::Link());
...
private:
    ...
    BasicProposalItem *itemFromSymbol(Symbol *symbol) const
    {
        ...
        const LuaEditorWidget::Link link = LuaEditorWidget::linkToSymbol(symbol);
