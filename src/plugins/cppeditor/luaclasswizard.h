...
struct LuaClassWizardParameters
{
    QString className;
    QString headerFile;
    QString sourceFile;
...
class LuaClassWizardDialog : public Utils::Wizard
{
    Q_OBJECT

public:
    explicit LuaClassWizardDialog(QWidget *parent = 0);

    void setPath(const QString &path);
    LuaClassWizardParameters parameters() const;
...
class LuaClassWizard : public Core::BaseFileWizard
{
    Q_OBJECT
...
private:
    ...
    static bool generateHeaderAndSource(const LuaClassWizardParameters &params,
