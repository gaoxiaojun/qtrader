...
*/
class AddIncludeForUndefinedIdentifier : public LuaQuickFixFactory
{
public:
...
// Exposed for tests
class AddIncludeForUndefinedIdentifierOp: public LuaQuickFixOperation
{
public:
...
*/
class AddIncludeForForwardDeclaration: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
/*!
  ...
  Activates on: <= < > >= == != && ||
*/
class FlipLogicalOperands: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
/*!
  ...
  Activates on: <= < > >= == !=
*/
class InverseLogicalComparison: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
/*!
  ...
  Activates on: &&
*/
class RewriteLogicalAnd: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
...
*/
class ConvertCStringToNSString: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
*/
class ConvertNumericLiteral: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
*/
class TranslateStringLiteral: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
class WrapStringLiteral: public LuaQuickFixFactory
{
public:
    enum ActionFlags {
...
*/
class ConvertToCamelCase : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
*/
class MoveDeclarationOutOfIf: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
/*!
  ...
  Activates on: the name of the introduced variable
*/
class MoveDeclarationOutOfWhile: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
/*!
  ...
  with
    ...
    Activates on: && or ||
*/
class SplitIfStatement: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
*/
class SplitSimpleDeclaration: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
...
*/
class AddLocalDeclaration: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
/*!
  ...
  Activates on: the if
*/
class AddBracesToIf: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
*/
class RearrangeParamDeclarationList : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
...
*/
class ReformatPointerDeclaration : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
 ...
 */
class CompleteSwitchCaseStatement: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, QuickFixOperations &result);
};
 ...
 */
class InsertDeclFromDef: public LuaQuickFixFactory
{
public:
 ...
 */
class InsertDefFromDecl: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class ExtractFunction : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class ExtractLiteralAsParameter : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class GenerateGetterSetter : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class InsertQtPropertyMembers : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class ApplyDeclDefLinkChanges: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class MoveFuncDefOutside: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class MoveFuncDefToDecl: public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
 ...
 */
class AssignToLocalVariable : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
...
class InsertVirtualMethods: public LuaQuickFixFactory
{
    Q_OBJECT
public:
 ...
 */
class OptimizeForLoop : public LuaQuickFixFactory
{
public:
    void match(const CppQuickFixInterface &interface, TextEditor::QuickFixOperations &result);
};
