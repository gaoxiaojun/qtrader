...
LuaFileWizard::LuaFileWizard(FileType type)
    : m_type(type)
{
}

Core::GeneratedFiles LuaFileWizard::generateFilesFromPath(const QString &path,
                                                          const QString &name,
...
QString LuaFileWizard::fileContents(FileType type, const QString &fileName) const
{
    QString contents;
