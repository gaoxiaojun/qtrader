...
class LuaQuickFixAssistInterface : public TextEditor::DefaultAssistInterface
{
public:
    LuaQuickFixAssistInterface(LuaEditorWidget *editor, TextEditor::AssistReason reason);

    const QList<CPlusPlus::AST *> &path() const;
    CPlusPlus::Snapshot snapshot() const;
    CppTools::SemanticInfo semanticInfo() const;
    const CPlusPlus::LookupContext &context() const;
    LuaEditorWidget *editor() const;
...
class LuaQuickFixAssistProcessor : public TextEditor::QuickFixAssistProcessor
{
public:
    LuaQuickFixAssistProcessor(const TextEditor::IAssistProvider *provider);
...
class LuaQuickFixAssistProvider : public TextEditor::QuickFixAssistProvider
{
public:
