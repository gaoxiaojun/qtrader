...
bool LuaAutoCompleter::contextAllowsAutoParentheses(const QTextCursor &cursor,
...
QString LuaAutoCompleter::insertMatchingBrace(const QTextCursor &cursor,
                                                const QString &text,
                                                QChar la,
...
QString LuaAutoCompleter::insertParagraphSeparator(const QTextCursor &cursor) const
{
    MatchingText m;
...
const Token LuaAutoCompleter::tokenAtPosition(const QList<Token> &tokens, const unsigned pos) const
{
