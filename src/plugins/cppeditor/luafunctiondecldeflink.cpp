...
void FunctionDeclDefLink::apply(LuaEditorWidget *editor, bool jumpToMatch)
{
...
void FunctionDeclDefLink::hideMarker(LuaEditorWidget *editor)
{
    if (!hasMarker)
        return;
...
void FunctionDeclDefLink::showMarker(LuaEditorWidget *editor)
{
    if (hasMarker)
        return;
