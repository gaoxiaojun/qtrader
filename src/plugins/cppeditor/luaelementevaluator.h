...
class LuaElementEvaluator
{
public:
    explicit LuaElementEvaluator(LuaEditorWidget *editor);
    ...
    const QSharedPointer<LuaElement> &cppElement() const;
...
private:
    ...
    QSharedPointer<LuaElement> m_element;
    QString m_diagnosis;
...
public:
    ...
    QString helpMark;
    LuaEditorWidget::Link link;
    QString tooltip;
};

class Unknown : public LuaElement
{
public:
...
class CppInclude : public LuaElement
{
public:
...
class CppMacro : public LuaElement
{
public:
    explicit CppMacro(const CPlusPlus::Macro &macro);
};

class CppDeclarableElement : public LuaElement
{
public:
...
class LuaFunction : public CppDeclarableElement
{
public:
    explicit LuaFunction(CPlusPlus::Symbol *declaration);
};
