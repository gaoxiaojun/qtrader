...
#include "luaeditor.h"
#include "luafunctiondecldeflink.h"
...
class RewriteLogicalAndOp: public LuaQuickFixOperation
{
public:
...
class SplitSimpleDeclarationOp: public LuaQuickFixOperation
{
public:
...
class AddBracesToIfOp: public LuaQuickFixOperation
{
public:
...
class MoveDeclarationOutOfIfOp: public LuaQuickFixOperation
{
public:
...
class MoveDeclarationOutOfWhileOp: public LuaQuickFixOperation
{
public:
...
class SplitIfStatementOp: public LuaQuickFixOperation
{
public:
...
class WrapStringLiteralOp : public LuaQuickFixOperation
{
public:
    ...
    WrapStringLiteralOp(const CppQuickFixInterface &interface, int priority,
        ...
        : LuaQuickFixOperation(interface, priority), m_actions(actions), m_literal(literal),
...
{
    typedef LuaQuickFixOperation::Ptr OperationPtr;
...
class ConvertCStringToNSStringOp: public LuaQuickFixOperation
{
public:
...
class ConvertNumericLiteralOp: public LuaQuickFixOperation
{
public:
...
class AddIncludeForForwardDeclarationOp: public LuaQuickFixOperation
{
public:
...
class AddLocalDeclarationOp: public LuaQuickFixOperation
{
public:
...
class ConvertToCamelCaseOp: public LuaQuickFixOperation
{
public:
    ...
    void perform()
    {
        ...
        static_cast<LuaEditorWidget*>(assistInterface()->editor())->renameUsagesNow(m_name);
    }
                                             ...
                                             QuickFixOperations &result)
{
    ...
    foreach (const Locator::FilterEntry &entry, matches) {
        ...
        if (!shortestInclude.isEmpty()) {
            result += LuaQuickFixOperation::Ptr(
...
class RearrangeParamDeclarationListOp: public LuaQuickFixOperation
{
public:
...
class ReformatPointerDeclarationOp: public LuaQuickFixOperation
{
public:
...
class CompleteSwitchCaseStatementOp: public LuaQuickFixOperation
{
public:
    CompleteSwitchCaseStatementOp(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
    ...
    for (int depth = path.size() - 1; depth >= 0; --depth) {
        ...
        if (switchStatement) {
            ...
            if (Enum *e = conditionEnum(interface, switchStatement)) {
                ...
                if (!values.isEmpty())
                    result.append(LuaQuickFixOperation::Ptr(new CompleteSwitchCaseStatementOp(interface, depth, compoundStatement, values)));
                return;
            }
...
class InsertDeclOperation: public LuaQuickFixOperation
{
public:
    InsertDeclOperation(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
...
class InsertDefOperation: public LuaQuickFixOperation
{
public:
    // Make sure that either loc is valid or targetFileName is not empty.
    InsertDefOperation(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
        ...
        : LuaQuickFixOperation(interface, 0)
        , m_decl(decl)
        , m_declAST(declAST)
        , m_loc(loc)
        , m_defpos(defpos)
                                ...
                                foreach (const InsertionLocation &location,
                                    ...
                                    if (location.isValid()) {
                                        op = new InsertDefOperation(interface, decl, declAST,
                                                                    ...
                                                                    DefPosImplementationFile,
                                                                    location.fileName());
                                        result.append(LuaQuickFixOperation::Ptr(op));
                                        break;
                                    }
                                }
                            }
...
class GenerateGetterSetterOperation : public LuaQuickFixOperation
{
public:
    GenerateGetterSetterOperation(const QSharedPointer<const LuaQuickFixAssistInterface> &interface)
        : LuaQuickFixOperation(interface)
        , m_variableName(0)
        , m_declaratorId(0)
        , m_declarator(0)
...
class ExtractFunctionOperation : public LuaQuickFixOperation
{
public:
...
void ExtractFunction::match(const CppQuickFixInterface &interface, QuickFixOperations &result)
{
    ...
    result.append(LuaQuickFixOperation::Ptr(new ExtractFunctionOperation(interface,
...
class ExtractLiteralAsParameterOp : public LuaQuickFixOperation
{
public:
...
class InsertQtPropertyMembersOp: public LuaQuickFixOperation
{
public:
    enum GenerateFlag {
        GenerateGetter = 1 << 0,
    ...
    InsertQtPropertyMembersOp(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
...
class ApplyDeclDefLinkOperation : public LuaQuickFixOperation
{
public:
    explicit ApplyDeclDefLinkOperation(const CppQuickFixInterface &interface,
            const QSharedPointer<FunctionDeclDefLink> &link)
        : LuaQuickFixOperation(interface, 100)
        , m_link(link)
    {}

    void perform()
    {
        LuaEditorWidget *editor = assistInterface()->editor();
...
QString definitionSignature(const LuaQuickFixAssistInterface *assist,
...
class MoveFuncDefOutsideOp : public LuaQuickFixOperation
{
public:
    enum MoveType {
        MoveOutside,
    ...
    MoveFuncDefOutsideOp(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
...
class MoveFuncDefToDeclOp : public LuaQuickFixOperation
{
public:
    MoveFuncDefToDeclOp(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
...
class AssignToLocalVariableOperation : public LuaQuickFixOperation
{
public:
...
class InsertVirtualMethodsOp : public LuaQuickFixOperation
{
public:
    InsertVirtualMethodsOp(const QSharedPointer<const LuaQuickFixAssistInterface> &interface,
...
class OptimizeForLoopOperation: public LuaQuickFixOperation
{
public:
