...
bool LuaHighlighter::isPPKeyword(const QStringRef &text) const
{
    switch (text.length())
    {
    case 2:
...
void LuaHighlighter::highlightLine(const QString &text, int position, int length,
...
void LuaHighlighter::highlightWord(QStringRef word, int position, int length)
{
...
void LuaHighlighter::highlightDoxygenComment(const QString &text, int position, int)
{
